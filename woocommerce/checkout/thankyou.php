				...
				<?php else : ?>
					...
					<div class="max-w-3xl mx-auto">
						<div class="ab-card bg-white shadow-[0_1px_2px_rgba(0,0,0,.04),0_12px_40px_rgba(0,0,0,.06)] px-12 py-10 md:px-24 md:py-20 text-center">
							...
							<dl class="woocommerce-order-overview woocommerce-thankyou-order-details order_details ab-meta mx-auto w-full max-w-xl grid grid-cols-2 gap-x-8 gap-y-3 items-start text-[14px] md:text-base leading-6">

...
<form class="checkout_coupon woocommerce-form-coupon flex items-center" method="post" style="display:none" id="woocommerce-checkout-form-coupon">

	<p class="form-row !mr-5">

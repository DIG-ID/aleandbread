...
<div <?php wc_product_class( 'card-product--experiences', $product ); ?>>
	<a href="<?php echo esc_url( $product_link ); ?>" class="flex flex-col xl:flex-row xl:justify-center xl:items-stretch w-full">
		<div class="max-w-full xl:max-w-[704px]">
			<?php echo get_the_post_thumbnail( $product->get_id(), 'full', array( 'class' => 'w-full h-full object-cover max-h-[216px] md:max-h-[416px] xl:max-w-[432px]' ) ); ?>
		</div>
		<div class="bg-dark text-white w-full px-24 py-16 flex justify-between items-start">
			<div class="card-content flex flex-col">
				<h2 class=" mb-2"><?php echo esc_html( $product_title ); ?></h2>
				<p class="mb-12">personas</p>
				<ul class=mb-12">
					<li>toaaosdad</li>
					<li>asdasda</li>
					<li>adasdasd</li>

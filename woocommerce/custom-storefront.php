...
<section class="shop-intro relative overflow-hidden">
	<div class="theme-grid pb-14 xl:pb-40">
		<div class="col-start-1 col-span-2 md:col-span-5 xl:col-start-2 xl:col-span-4">
			<h1 class="text-dark"><?php the_field( 'intro_title', get_option( 'woocommerce_shop_page_id' ) ); ?></h1>
		</div>
						...
						<a href="<?php the_permalink(); ?>">
							...
							<div class="card-best-sellers--content">
								...
								<div class="card-best-sellers--footer flex justify-between items-center">
									<div>
										<h2 class="card-best-sellers--title uppercase"><?php the_title(); ?></h2>
										<?php if ( ! empty( $slogan ) ) : ?>
			...
			<div class="swiper-wrapper items-stretch">
				...
				foreach ( $testimonials_posts as $post ) :
					...
					<div class="swiper-slide testimonial-card h-auto">
						<div class="testimonial-card-content bg-white py-10 pl-12 pr-16 flex flex-col justify-between min-h-full">

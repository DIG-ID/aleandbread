...
?>
<section id="past-events" class="section-past-events relative overflow-hidden bg-background my-[55px] md:my-[92px] xl:my-[195px]">

	<div class="theme-container theme-grid">
		<div class="col-span-2 md:col-span-6 xl:col-span-12 xl:col-start-2">
			<h2 class="h2 mb-20"><?php esc_html_e( 'Vergangene Events', 'aleandbread' ); ?></h2>
		</div>
	</div>
	...
	<div class="theme-container relative z-10">
		...
		<?php if ( $the_query->have_posts() ) : ?>
			...
			<div class="events-swiper-scope" data-events-swiper="past">

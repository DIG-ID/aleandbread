      ...
      <div class="col-span-2 md:col-span-6 xl:col-span-5 xl:col-start-8 pt-[72px] md:pt-[128px] xl:pt-[280px] order-1 xl:order-none">
        ...
        if( $gallery ): ?>
          <div class="swiper our-experience-swiper relative">
            ...
            <!-- Navigation buttons -->
            <div class="hidden xl:block swiper-button-prev-3 absolute top-1/2 -translate-y-1/2 left-4 z-10"></div>
            <div class="hidden xl:block swiper-button-next-3 absolute top-1/2 -translate-y-1/2 right-4 z-10"></div>
          </div>
        <?php endif; ?>
      </div>

    ...
    <div class="theme-container pt-[130px] md:pt-[194px] xl:pt-[280px]">
        <div class="theme-grid">
            ...
            <div class="col-start-1 xl:col-start-2 col-span-2 md:col-span-5 xl:col-span-4">
                ...
                <h3 class="text-dark mb-7 md:mb-9"><?php echo get_field('kontakt_sub_title'); ?></h3>
                <p class="block-text text-blockText mb-12 md:mb-14"><?php echo get_field('kontakt_description'); ?></p>
            </div>

            <div class="col-start-1 xl:col-start-8 col-span-2 md:col-span-6 xl:col-span-2 self-start">
                <h1 class="text-dark mb-7 md:mb-16 xl:mb-[74px]">
                ...
                if ($address): ?>
                    <div class="flex items-center xl:justify-center mb-7 md:mb-8 xl:mb-12">
            ...
            <div class="col-start-1 xl:col-start-2 col-span-6 xl:col-span-10 pt-16 md:pt-20 xl:pt-40 md:mb-52 xl:mb-[283px]">
                <div class=" bg-[#140606] pr-8 pl-8 md:pl-[60px] md:pr-[60px] xl:pr-16 xl:pl-16 pb-6 pt-1">

	...
	<div class="theme-container">
		<div class="theme-grid">
			<div class="col-span-2 md:col-span-6 xl:col-span-12 grid grid-cols-2 md:grid-cols-6 xl:grid-cols-12 md=:pt-[58px] xl:pt-[139px] gap-4">
				...
				<h2 class="h1 text-blockTextLight w-[305px] md:w-[550px] xl:w-[380px] col-span-2 md:col-span-5 col-start-1 xl:col-start-4 pt-0 md:pt-[56px] xl:pt-0"><?php echo get_field('craftmanship_title'); ?></h2>

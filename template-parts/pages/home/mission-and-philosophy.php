	...
	<div class="theme-container pt-8 md:pt-16 xl:pt-0">
		<div class="theme-grid">
			...
			<div class="col-start-1 md:col-start-1 xl:col-start-8 col-span-2 md:col-span-5 xl:col-span-4 order-2">
				<h2 class="over-title text-accent"><?php echo get_field('mission_und_philosophie_over_title'); ?></h2>
				
				<h3 class="h1 text-blockTextLight pt-12 md:pt-20 xl:pt-10 pb-11 md:pb[60px] xl:pb-10 w-[343px] md:w-[560px] xl:w-full">

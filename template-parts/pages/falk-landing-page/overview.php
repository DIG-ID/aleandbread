		...
		<div class="theme-grid">
            ...
            <div class="col-span-2 md:col-start-1 md:col-span-3 xl:col-start-2 xl:col-span-3 max-w-[379px] flex flex-col">
                ...
                <?php
						...
						?>
						<a class="btn btn-primary-2 mt-auto mb-14 xl:mb-0" href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
						<?php echo esc_html($link_title); ?>
						</a>
					<?php endif; ?>
            </div>
            <div class="col-span-2 md:col-start-4 md:col-span-3 xl:col-start-5 xl:col-span-3 xl:pl-8 flex flex-col">
            ...
            <div class="col-span-2 md:col-span-3 xl:col-start-8 xl:col-span-3 xl:pl-20 flex flex-col">
                ...
                <?php
						...
						$link_target = $button['target'] ? $button['target'] : '_self';
						?>
						<a class="btn btn-primary-2 mt-auto" href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
						<?php echo esc_html($link_title); ?>
						</a>
					<?php endif; ?>
            </div>

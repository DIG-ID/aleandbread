 ...
 * pattern. The preconnect hint is handled separately via aleandbread_theme_theme_resource_hints().
 *
 * @param string $html   The full <link> tag HTML generated by WordPress.
 * @param string $handle The registered style handle.
 * @return string
 */
function aleandbread_theme_typekit_non_blocking_loader( string $html, string $handle ): string {
